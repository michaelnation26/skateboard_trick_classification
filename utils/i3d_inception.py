"""*This Keras I3D implementation is from dlpbc's GitHub. Minor changes were made.
AveragePooling3D in the last layer was changed to GlobalAveragePooling3D.
...
WEIGHTS_PATH_NO_TOP = {
    ...
    'rgb_imagenet_and_kinetics' : 'https://github.com/michaelnation26/skateboard_trick_classification/releases/download/1.0/rgb_inception_i3d_imagenet_and_kinetics_tf_dim_ordering_tf_kernels_no_top.h5',
